...
export const RECIPES_USE_MOCK = true;
export const RECIPES_FAKE_LATENCY_MS = 600;
export const RECIPES_MOCK_TOTAL = 56;
...
export const MOCK_RECIPES: Recipe[] = Array.from({ length: RECIPES_MOCK_TOTAL }, (_, i) =>
  makeMockRecipe(i + 1),
);
