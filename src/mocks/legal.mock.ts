import type { LegalKey, LegalManifestItem } from '../api/legal';

export const LEGAL_USE_MOCK = true;
export const LEGAL_FAKE_LATENCY_MS = 300;

export const MOCK_LEGAL_MANIFEST: LegalManifestItem[] = [
  {
...
export const MOCK_LEGAL_CONTENT: Record<LegalKey, string> = {
